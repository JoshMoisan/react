...
const newRecipe = () => {
  ...
  return (
    <div>
      <div className="text">
        <h1 >Adding a recipe for <br /> this week ...</h1>
      </div>
      ...
      <div className="form">
        <form>
          ...
          <label for="choice1"> Fish </label>
            <input type="checkbox" id="choice1" name="choice1" value="Fish" />
          <label for="choice2"> Nut </label>
            <input type="checkbox" id="choice2" name="choice2" value="Nut" />
          <label for="choice3"> Egg </label>
            <input type="checkbox" id="choice3" name="choice3" value="Egg" />
          <label for="choice4"> Soy </label>
            <input type="checkbox" id="choice4" name="choice4" value="Soy" />
